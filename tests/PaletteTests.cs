...
public class PaletteTests
{
    ...
    // lockstep with HighFantasyThemePlugin.GetPalettes(); the catalog test
    // below is what enforces that they stay in sync.
    public static readonly (string Id, string Name, string Uri)[] Expected =
    {
        ("tavern-hearth", "Tavern Hearth", "avares://HighFantasyThemePlugin/Themes/TavernHearth.axaml"),
        ("deep-dungeon",  "Deep Dungeon",  "avares://HighFantasyThemePlugin/Themes/DeepDungeon.axaml"),
    };
    ...
    {
        var palettes = new HighFantasyThemePlugin().GetPalettes().ToArray();
